...
class Settings extends Component {
  ...
  state = {autoMode: window.settings.autoMode};

  toggleAutoMode = () => {
    this.setState({autoMode: window.settings.autoMode});
  }
      ...
      <div className='settings'>
        ...
        <List>
          <ListSection>
            ...
            <Link to='/settings/修改我的用户名'><Li>修改我是谁<Expand/></Li></Link>
          </ListSection>
          <ListSection>
          ...
          <ListSection>
            <Li>
              <span className='label'>使用<Link to='/settings/智能模式'>智能模式</Link></span>
              <Toggle checked={window.settings.autoMode} setting='autoMode' toggleAutoMode={this.toggleAutoMode}/>
            </Li>
          </ListSection>
          {this.renderLabels()}
        </List>
