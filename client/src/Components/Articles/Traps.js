  ...
  return (
    <div className='plain-article'>
      ...
      <article>
        ...
        <p></p>
        <p>2. 使用生僻字</p>
        <p>{姓}筱箴, {姓}隽诣, {姓}芮翎, 这些字你全都认识, 一点都不生僻, 对不对? 告诉你, 你的文化程度太高了! 别把广大老百姓不放在心上!</p>
        <p></p>
        <p>3. 追求生辰八字, 风水五行</p>
        <p>首先你要想清楚, 什么是好名字? 好名字的标准是什么?</p>
        <p>如果你对好名字的定义是"好听, 好用, 寓意好", 那追求风水五行就是舍本逐末, 因为条条框框会缩窄你搜寻好名字的范围。</p>
        <p>另外, 如果有一个算命先生会算八字, 请你思考一下: 他是怎么学会的? 是谁教他的?</p>
        <p>如果你找三个算命先生, 他们会给出一模一样的结论吗? 会不会一个说缺水, 一个说缺火?</p>
        <p></p>
        <p>4. 执着于典故和出处</p>
        ...
        <p>所以说, 起名字的时候要注意, 必须让不知道典故的人也觉得好听。上万人觉得好听和10个人觉得好听, 哪个优先?</p>
        <p></p>
        <p>5. 兄弟姐妹共享同一个字</p>
        <p>假如你对好名字的定义是"好听, 好用, 寓意好", 那执着于兄弟姐妹共享同一个字就变成了舍本逐末, 因为这会缩窄你搜寻好名字的范围。</p>
        <p></p>
        <p>6. 执着于辈分</p>
        <p>有些家庭讲究名字中带上孩子的辈分, 通常是中间一个字。还是那句话, 假如你对好名字的定义是"好听, 好用, 寓意好", 那追求带上辈分就变成了舍本逐末, 因为这会缩窄你搜寻好名字的范围。</p>
        <p></p>
        <p>7. 使用中性名字</p>
        <p>有些家长因为不知道宝宝的性别, 所以提前起了一个中性的名字, 这是比较不负责任的。</p>
        <p>同样的, 这样会缩窄你搜寻好名字的范围。有大量好听的字, 都是只适用一个性别的。比较好的做法是男名女名分别准备一个。</p>
        <p></p>
        <p>8. 为了好听, 忽略了实用</p>
        <p>举几个例子, 都是非常好听的名字(也都是本软件的"智能模式"给出的名字)。</p>
        <p>例一:</p>
        <p>你在楼下玩, 你妈在阳台喊你: "{姓}云慈! 回家吃饭! "</p>
        <p>这个名字的问题是大声喊的时候喊不响。</p>
        <p>例二:</p>
        <p>你的小伙伴喊你: "{姓}心钥! {姓}心钥! 传球! "</p>
        <p>这个名字有两个问题, 第一个问题是当"钥"字出现在"钥匙"当中时, 人人都会读, 可以一旦单独拎出来, 很多人就可能会读成"月"。第二个问题是后两字的界限不清, 读快了听起来像"{姓}笑"。</p>
        <p>例三:</p>
        <p>别人问: "你叫什么名字?"</p>
        <p>你: "{姓}听骤"</p>
        <p>别人(不确定): "什么? "</p>
        <p>你(放慢速度): "{姓}听骤, 听见的听, 暴风骤雨的骤"。</p>
        <p>别人: "哦哦哦!"</p>
